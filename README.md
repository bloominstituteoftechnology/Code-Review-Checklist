...
Option one is not available to Lambda School students. With option 2, you should find that GitHub support is very friendly and timely in their responses. If, however, you want to get your "Heat Map" to reflect your work on your own, then please visit [this repository](https://github.com/LambdaSchool/GitHub-Contribution-Graph). You will find detailed instructions on how to "de-fork" your repositories. :octocat:
